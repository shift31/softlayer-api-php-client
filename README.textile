...
The SLSoapClient class requires at least PHP 5.2.3 and the PHP SOAP extension installed. The SLXmlrpcClient class requires PHP at least PHP 5 and the PHP XML-RPC extension installed.
